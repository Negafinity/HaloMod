...
public class ItemWarthogTurret extends Item
{
	// Following is so you can access it in pre-init
	public static final ItemWarthogTurret instance = new ItemWarthogTurret();
	public static final String name = "itemWarthogTurret";
		...
		else
		{
			...
			else
			{
				if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
				{
					...
					EntityWarthogTurret entitymongoose = new EntityWarthogTurret(worldIn, (double) ((float) blockpos.getX() + 0.5F), (double) ((float) blockpos.getY() + 1.0F), (double) ((float) blockpos.getZ() + 0.5F));
