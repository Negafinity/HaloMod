...
public class ItemWarthog extends Item
{
	// Following is so you can access it in pre-init
	public static final ItemWarthog instance = new ItemWarthog();
	public static final String name = "itemWarthog";
		...
		else
		{
			...
			else
			{
				if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
				{
					...
					EntityWarthog entitymongoose = new EntityWarthog(worldIn, (double) ((float) blockpos.getX() + 0.5F), (double) ((float) blockpos.getY() + 1.0F), (double) ((float) blockpos.getZ() + 0.5F));
