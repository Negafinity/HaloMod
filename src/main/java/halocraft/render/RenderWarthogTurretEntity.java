...
public class RenderWarthogTurretEntity extends Render
{
    ...
    IModel model = null;
    public RenderWarthogTurretEntity(RenderManager p_i46190_1_)
    {
        super(p_i46190_1_);
    ...
    public void doRender(EntityWarthogTurret par1EntityMongoose, double p_180552_2_, double p_180552_4_, double p_180552_6_, float p_180552_8_, float p_180552_9_) throws IOException
    {
