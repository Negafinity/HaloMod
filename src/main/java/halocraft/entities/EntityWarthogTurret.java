...
public class EntityWarthogTurret extends Entity {
	...
	private double boatPitch;@SideOnly(Side.CLIENT)
	private double velocityX;@SideOnly(Side.CLIENT)
	private double velocityY;@SideOnly(Side.CLIENT)
	private double velocityZ;
	public EntityPlayer secondRider;
	public EntityPlayer thirdRider;
	...
	public EntityWarthogTurret(World worldIn, double x, double y, double z) {
		this(worldIn);
		...
		if (this.isEntityInvulnerable(source)) {
			...
			if (this.riddenByEntity != null && this.riddenByEntity == source.getEntity() && source instanceof EntityDamageSourceIndirect) {
				...
				if (flag || this.getDamageTaken() > 40.0F) {
					...
					if (!flag) {
						this.dropItemWithOffset(ItemWarthogTurret.instance, 1, 0.0F);
					}
