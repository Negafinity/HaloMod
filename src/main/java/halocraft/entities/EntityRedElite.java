...
public class EntityRedElite extends EntityMob implements IMob, IRangedAttackMob
{
	public EntityRedElite(World worldIn) {
		...
		this.setCurrentItemOrArmor(0, new ItemStack(ItemCarbineRifle.instance));
		this.experienceValue = 5;
		this.tasks.addTask(1, new EntityAIArrowAttack(this, 0.4D, 8, 24));
	...
	{
		return new ItemStack(ItemCarbineRifle.instance, 1);
	}
	...
	public void attackEntityWithRangedAttack(EntityLivingBase entityLivingIn, float p_82196_2_)
	{
		...
		if(this.getAttackTarget() != null)
		{
			...
			double d1 = this.getAttackTarget().getEntityBoundingBox().maxY - 0.2 - this.posY;
