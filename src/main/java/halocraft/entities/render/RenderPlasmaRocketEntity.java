...
public class RenderPlasmaRocketEntity extends Render{
	private static final ResourceLocation rocketTextures = new ResourceLocation("halocraft:textures/entities/PlasmaRocketRender.png");
	...
	public void render(EntityPlasmaRocket rocket, double d, double d1, double d2, float f, float f1)
	{
	...
	{
		render((EntityPlasmaRocket) entity, d, d1, d2, f, f1);
	}
