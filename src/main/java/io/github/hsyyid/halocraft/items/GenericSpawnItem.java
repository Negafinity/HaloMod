...
public class GenericSpawnItem extends Item
{
	public Class<? extends Entity> entityClass;

	public GenericSpawnItem(Class<? extends Entity> entityClass)
	{
		super();
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
	{
		...
		RayTraceResult movingobjectposition = worldIn.rayTraceBlocks(vec3, vec31, true);
			...
			else
			{
				if (movingobjectposition.typeOfHit == RayTraceResult.Type.BLOCK)
				{
					...
					try
					{
						...
						Entity entity = entityConstructor.newInstance(worldIn);
